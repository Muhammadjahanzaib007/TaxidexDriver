                                      ...
                                      return MapEntry(
                                          ...
                                          Container(
                                              ...
                                              decoration: BoxDecoration(
                                                  border: Border.all(color: underline, width: 1),
                                                  borderRadius: BorderRadius.circular(12)),
                                              child: InkWell(
                                                onTap: () async {
                                                  fleetdocsId = fleetdocumentsNeeded[i]['id'];
                                                  fleetchoosenDocs = i;
                                                ...
                                                child: (fleetdocumentsNeeded[i]['is_uploaded'] == false)
                                                    ? Row(
                                                          ...
                                                          Column(
                                                            ...
                                                            children: [
                                                              SizedBox(
                                                                ...
                                                                child: Text(
                                                                  (languages[choosenLanguage][fleetdocumentsNeeded[i]
                                                                                  ['name']
                                                                              .toString()] !=
                                                                          null)
                                                                      ? languages[choosenLanguage]
                                                                          [fleetdocumentsNeeded[i]['name'].toString()]
                                                                      : fleetdocumentsNeeded[i]['name'].toString(),
                                                                  style: GoogleFonts.roboto(
                                                              ...
                                                              Container(
                                                                ...
                                                                decoration: BoxDecoration(
                                                                    ...
                                                                    image: DecorationImage(
                                                                        image: NetworkImage(fleetdocumentsNeeded[i]
                                                                            ['fleet_document']['data']['document']),
                                                                        fit: BoxFit.cover)),
                                                                ...
                                                                children: [
                                                                  ...
                                                                  (fleetdocumentsNeeded[i]['fleet_document']['data']
                                                                      ...
                                                                      ? Container(
                                                                          ...
                                                                          child: Text(
                                                                            fleetdocumentsNeeded[i]['fleet_document']
                                                                                ['data']['comment'],
                                                                            style: GoogleFonts.roboto(
                                                                              fontSize: media.width * twelve,
                                                                            ),
...
//date picker
  _datePicker() async {
    DateTime? picker =
        await showDatePicker(context: context, initialDate: current, firstDate: current, lastDate: DateTime(2100));
    if (picker != null) {
      setState(() {
        fleetexpDate = picker;
...
//image pick from gallery
  imagePick() async {
    ...
    if (permission == PermissionStatus.granted) {
      final pickedFile = await _fleetpicker.pickImage(source: ImageSource.gallery);
      setState(() {
...
//image pick from camera
  cameraPick() async {
    ...
    if (permission == PermissionStatus.granted) {
      final pickedFile = await _fleetpicker.pickImage(source: ImageSource.camera);
      setState(() {
        fleetimageFile = pickedFile?.path;
        _uploadImage = false;
      });
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(12), border: Border.all(color: buttonColor, width: 1.2)),
                          ...
                          ? Column(
                              ...
                              children: [
                                Text(
                                  languages[choosenLanguage]['text_upload_docs'],
                                  style: GoogleFonts.roboto(
                                      fontSize: media.width * fifteen, fontWeight: FontWeight.w600, color: textColor),
                  ...
                  (fleetdocumentsNeeded[fleetchoosenDocs]['has_expiry_date'] == true)
                      ? Container(
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              decoration:
                                  BoxDecoration(border: Border(bottom: BorderSide(color: underline, width: 1.5))),
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  (fleetdate != '')
                                      ? Text(
                                          fleetdate,
                                          style: GoogleFonts.roboto(color: textColor, fontSize: media.width * sixteen),
                                        )
                                      : Text(
                                          'Select Date',
                                          style: GoogleFonts.roboto(
                                              color: textColor.withOpacity(0.5), fontSize: media.width * sixteen),
                                        ),
                      ...
                      : Container(),
                  (fleetdocumentsNeeded[fleetchoosenDocs]['has_identify_number'] == true)
                      ? Container(
                          padding: EdgeInsets.only(top: media.height * 0.02),
                          child: InputField(
                            text: (languages[choosenLanguage][fleetdocumentsNeeded
                                        .firstWhere(
                                            (element) => element['id'] == fleetdocsId)['identify_number_locale_key']
                                        .toString()] !=
                                    null)
                                ? languages[choosenLanguage]
                                    [fleetdocumentsNeeded[fleetdocsId]['identify_number_locale_key'].toString()]
                  ...
                  (fleetimageFile != null && (fleetdocumentsNeeded[fleetchoosenDocs]['has_identify_number'] == true)
                          ? idNumber.text.isNotEmpty
                          : 1 + 1 == 2 && (fleetdocumentsNeeded[fleetchoosenDocs]['has_expiry_date'] == true)
                              ? fleetdate != ''
                              : 1 + 1 == 2)
                      ? Button(
                          onTap: () async {
