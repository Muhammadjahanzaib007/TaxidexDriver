...
import 'package:taxidex_driver/pages/NavigatorPages/historydetails.dart';
                    ...
                    children: [
                      InkWell(
                        ...
                        child: Container(
                            ...
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(12),
                                color: (_showHistory == 0) ? const Color(0xff222222) : page),
                            child: Text(
                              languages[choosenLanguage]['text_upcoming'],
                              style: GoogleFonts.roboto(
                                  fontSize: media.width * fifteen,
                                  fontWeight: FontWeight.w600,
                                  color: (_showHistory == 0) ? Colors.white : textColor),
                            )),
                      ),
                      InkWell(
                        onTap: () async {
                        ...
                        child: Container(
                            ...
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(12),
                                color: (_showHistory == 1) ? const Color(0xff222222) : page),
                            child: Text(
                              languages[choosenLanguage]['text_completed'],
                              style: GoogleFonts.roboto(
                                  fontSize: media.width * fifteen,
                                  fontWeight: FontWeight.w600,
                                  color: (_showHistory == 1) ? Colors.white : textColor),
                            )),
                      ),
                      InkWell(
                        onTap: () async {
                        ...
                        child: Container(
                            ...
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(12),
                                color: (_showHistory == 2) ? const Color(0xff222222) : page),
                            child: Text(
                              languages[choosenLanguage]['text_cancelled'],
                              style: GoogleFonts.roboto(
                                  fontSize: media.width * fifteen,
                                  fontWeight: FontWeight.w600,
                                  color: (_showHistory == 2) ? Colors.white : textColor),
                            )),
                      )
                    ],
                  ),
                  ...
                  child: Column(
                    children: [
                                                  ...
                                                  InkWell(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      padding: EdgeInsets.fromLTRB(media.width * 0.025,
                                                          media.width * 0.05, media.width * 0.025, media.width * 0.05),
                                                      decoration: BoxDecoration(
                                                          borderRadius: BorderRadius.circular(12),
                                                          color: page,
                                                          boxShadow: [
                                                                    ...
                                                                    Column(
                                                                      children: [
                                                                        ...
                                                                        Row(
                                                                          children: [
                                                                            Text(
                                                                              (myHistory[i]['total_time'] < 50)
                                                                                  ? myHistory[i]['total_distance'] +
                                                                                      myHistory[i]['unit'] +
                                                                                      ' - ' +
                                                                                      myHistory[i]['total_time']
                                                                                          .toString() +
                                                                                      ' mins'
                                                                                  : myHistory[i]['total_distance'] +
                                                                                      myHistory[i]['unit'] +
                                                                                      ' - ' +
                                                                                      (myHistory[i]['total_time'] / 60)
                                                                                          .round()
                                                                                          .toString() +
                                                                                      ' hr',
                                                                              style: GoogleFonts.roboto(
                                                            ...
                                                            children: [
                                                              Container(
                                                                ...
                                                                child: Container(
                                                                  ...
                                                                  width: media.width * 0.025,
                                                                  decoration: const BoxDecoration(
                                                                      shape: BoxShape.circle, color: Color(0xff319900)),
                                                                ),
                                                              ),
                                                              SizedBox(
                                                                width: media.width * 0.05,
                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                          ...
                                                                          decoration: BoxDecoration(
                                                                              shape: BoxShape.circle,
                                                                              image: DecorationImage(
                                                                                  image: NetworkImage(myHistory[i]
                                                                                          ['userDetail']['data']
                                                                                      ['profile_picture']),
                                                                                  fit: BoxFit.cover)),
                                                                        ),
                      ...
                      (myHistoryPage['pagination'] != null)
                          ? (myHistoryPage['pagination']['current_page'] < myHistoryPage['pagination']['total_pages'])
                              ? InkWell(
                                  onTap: () async {
                                    setState(() {
                                      _isLoading = true;
