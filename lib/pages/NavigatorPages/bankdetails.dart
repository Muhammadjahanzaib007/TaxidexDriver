                ...
                child: Column(
                  children: [
                              ...
                              children: [
                                TextField(
                                  ...
                                  decoration: InputDecoration(
                                      ...
                                      border:
                                          OutlineInputBorder(borderRadius: BorderRadius.circular(12), gapPadding: 1),
                                      isDense: true),
                                ),
                                SizedBox(
                                  height: media.width * 0.05,
                          ...
                          : Column(
                              children: [
                                Container(
                                  ...
                                  decoration:
                                      BoxDecoration(borderRadius: BorderRadius.circular(12), color: page, boxShadow: [
                    ...
                    (_edit == true || bankData.isEmpty)
                        ? Row(
                            mainAxisAlignment:
                                (bankData.isEmpty) ? MainAxisAlignment.center : MainAxisAlignment.spaceBetween,
                            children: [
                              (bankData.isNotEmpty)
                                  ? Button(
                                      onTap: () {
                              ...
                              Button(
                                  onTap: () async {
                                    ...
                                    if (holderName.text.isNotEmpty &&
                                      ...
                                      var val = await addBankData(
                                          holderName.text, accountNumber.text, bankCode.text, bankName.text);
                                      if (val == 'success') {
                                        setState(() {
                                          _edit = false;
                                        });
                                  ...
                                  width: (bankData.isEmpty) ? null : media.width * 0.4,
