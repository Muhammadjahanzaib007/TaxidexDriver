...
import 'package:taxidex_driver/pages/NavigatorPages/assigndriver.dart';
import 'package:taxidex_driver/pages/NavigatorPages/fleetdocuments.dart';
                                              ...
                                              child: Row(
                                                children: [
                                                  ...
                                                  Expanded(
                                                      ...
                                                      child: Stack(
                                                        children: [
                                                          vehicledata[i]['approve'].toString() == '1'
                                                              ? Center(
                                                                  child: Container(
                                                                ...
                                                                child: Column(
                                                                    ...
                                                                    children: [
                                                                      vehicledata[i]['driverDetail'] != null
                                                                          ? Text(
                                                                              vehicledata[i]['driverDetail']['data']
                                                                                      ['name']
                                                                                  .toString(),
                                                                              style: GoogleFonts.roboto(
                                                                                  fontSize: media.width * fourteen,
                                                            ...
                                                            InkWell(
                                                              onTap: () {
                                                                setState(() {
                                                                  ...
                                                                  fleetid = vehicledata[int.parse(isclickmenu)]['id'];
                                                                });
                                                              },
                                                              child: const Icon(
                                                                Icons.more_vert,
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            MenuClass(
                                                              ...
                                                              text: languages[choosenLanguage]['text_upload_doc'],
                                                            ),
                                                          ],
                                                        ),
                                                      ),
...
class MenuClass extends StatelessWidget {
  ...
  const MenuClass({Key? key, required this.text, required this.ontap}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: EdgeInsets.only(left: media.width * 0.03, top: media.width * 0.01),
      child: InkWell(
        onTap: ontap,
        child: SizedBox(
          width: media.width * 0.3,
