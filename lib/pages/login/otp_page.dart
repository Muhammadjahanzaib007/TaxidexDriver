  ...
  navigate(verify) {
    if (verify == true) {
      ...
      if (ischeckownerordriver == 'driver') {
        ...
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const OwnersRegister()));
      }
    }
  }
                            ...
                            child: Align(
                              ...
                              child: Text(
                                ...
                                style: GoogleFonts.roboto(
                                    fontSize: media.width * thirtysix, fontWeight: FontWeight.normal, color: primary),
                              ),
                            ),
                          ),
                          SizedBox(
                          ...
                          Container(
                            ...
                            child: Button(
                              onTap: () async {
                                ...
                                } else if (phoneAuthCheck == true && resendTime == 0 && otpNumber.length != 6) {
                                  setState(() {
                                    setState(() {
                                      resendTime = 60;
                                    });
                              ...
                              borcolor: (resendTime != 0 && otpNumber.length != 6) ? underline : null,
                              ...
                              color: (resendTime != 0 && otpNumber.length != 6) ? underline : null,
                            ),
                          ),
                        ],
                      ),
